<template lang="html">
  <div class="ndm">
    <div ref="produce" class="data-show" v-show="isShowPage">
      <div class="content">
        <img :src="'../../../static/images/scratch_sleep/'+scratchData.scratch_info.a+'.png'" alt="" class="result">
        <div class="content-list">
          <div v-for="item in scratchData.scratch_info.list" :class="[{'bonus': ((scratchData.scratch_info.a == item.data) && isShow)}]">
            <img :src="'../../../static/images/scratch_sleep/'+item.data+'.png'" alt="">
            <img :src="'../../../static/images/scratch_sleep/'+(item.money>9?item.money:'0'+item.money)+'.png'" alt="">
          </div>
        </div>
      </div>
    </div>
    <canvas id="ndm" :class="[{'on': payout}]">您的浏览器不支持canvas技术，请更换浏览器</canvas>
  ...
  export default {
    ...
    data() {
      return{
        ...
        img: {
          canvasImg: "http://scard-images.mohasomnang.com/tickets/2019/NDM/NDM-pre.jpg"
        },
    ...
    mounted() {
      this.$nextTick(() => {
        this.canvas = document.getElementById('ndm');
...
<style lang="less" scoped>
  .ndm{
    ...
    .data-show{
      ...
      padding-left: 15px;
      padding-right: 15px;
      background: url(http://scard-images.mohasomnang.com/tickets/2019/NDM/NDM-open.jpg);
  ...
  .content{
    ...
    .result{
      ...
      top: 50%;
      left: 50%;
      transform: translate3d(-232px, -240px, 0);
    }
    .bonus{
    ...
    .content-list{
      ...
      left: 50%;
      width: 393px;
      transform: translate3d(-3px, -90px, 0);
      div{
        position: absolute;
        top: 50%;
        left: 50%;
        ...
        &:nth-of-type(1) {
          transform: translate3d(-185px, -3px, 0);
        }
        &:nth-of-type(2) {
          transform: translate3d(-64px, -3px, 0);
        }
        &:nth-of-type(3) {
          transform: translate3d(60px, -3px, 0);
        }
        &:nth-of-type(4) {
          transform: translate3d(-185px, 124px, 0);
        }
        &:nth-of-type(5) {
          transform: translate3d(-64px, 124px, 0);
        }
        &:nth-of-type(6) {
          transform: translate3d(60px, 124px, 0);
        }
      }
    }
  }
