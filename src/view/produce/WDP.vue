    ...
    <div ref="produce" class="data-show" v-show="isShowPage">
      <div class="content">
        <div class="content-list">
          <div v-for="item in scratchData.scratch_info.list" :class="[{'bonus': (( (item.data == scratchData.scratch_info.a[0]) || (item.data == scratchData.scratch_info.a[1]) ) && isShow)}]">
            <span>{{item.data}}</span>
            <img :src="'../../../static/images/scratch_worldcup/prize_'+item.money+'.png'" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    data() {
      return{
        ...
        img: {
          canvasImg: "http://scard-images.mohasomnang.com/tickets/2019/WDP/WDP-pre.jpg"
        },
...
<style lang="less" scoped>
  .ndm{
    ...
    .data-show{
      ...
      padding-left: 15px;
      padding-right: 15px;
      background: url(http://scard-images.mohasomnang.com/tickets/2019/WDP/WDP-open.jpg);
    ...
    .serial-number {
      ...
      top: 50%;
      z-index: 2;
      transform: translate3d(-40px, 470px, 0);
      padding: 2px 7.5px;
  ...
  .content{
    ...
    .content-list{
      ...
      width: 640.5px;
      height: 322.5px;
      transform: translate3d(-318px, 90px, 0);
      display: flex;
      align-items: center;
      flex-wrap: wrap;
      padding: 0 15px;
