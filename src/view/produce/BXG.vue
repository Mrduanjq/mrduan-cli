    ...
    <div ref="produce" class="data-show" v-show="isShowPage">
      <div class="content">
        <div class="content-list">
          <img v-for="item in scratchData.scratch_info.list" :class="[{'bonus': ((scratchData.scratch_info.a == item) && isShow)}]" :src="'../../../static/images/scratch_boxing/'+item+'.png'" alt="">
        </div>
      </div>
    </div>
    <canvas id="bxg" :class="[{'on': payout}]">您的浏览器不支持canvas技术，请更换浏览器</canvas>
  ...
  export default {
    ...
    data() {
      return{
        ...
        img: {
          canvasImg: "http://scard-images.mohasomnang.com/tickets/2019/BXG/BXG-pre.jpg"
        },
    ...
    mounted() {
      this.$nextTick(() => {
        this.canvas = document.getElementById('bxg');
        // this.initAudio();
...
<style lang="less" scoped>
  .bxg{
    ...
    .data-show{
      ...
      padding-left: 15px;
      padding-right: 15px;
      background: url(http://scard-images.mohasomnang.com/tickets/2019/BXG/BXG-open.jpg);
  ...
  .content{
    ...
    .content-list{
      ...
      left: 50%;
      width: 250px;
      transform: translate3d(-310px, -60px, 0);
      img {
      	position: absolute;
				top: 50%;
				left: 50%;
        width: 142.5px;
				&:nth-of-type(1) {
				  transform: translate3d(-57.5px, -55px, 0);
				}
				&:nth-of-type(2) {
				  transform: translate3d(-137.5px, 0px, 0);
				}
				&:nth-of-type(3) {
				  transform: translate3d(2.5px, 0px, 0);
				}
				&:nth-of-type(4) {
				  transform: translate3d(-137.5px, 47.5px, 0);
				}
				&:nth-of-type(5) {
				  transform: translate3d(2.5px, 47.5px, 0);
				}
	      &:nth-of-type(6) {
	        transform: translate3d(-57.5px, 95px, 0);
	      }
      }
      ...
      // &:nth-of-type(7) {
      //   transform: translate3d(-70.5px, 55px, 0);
      // }
    }
  }
</style>
