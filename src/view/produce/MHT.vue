<template lang="html">
  <div class="mht">
    <div ref="produce" class="data-show" v-show="isShowPage">
      <div class="content">
        <img :src="'../../../static/images/scratch_nativeland/'+scratchData.scratch_info.a+'.png'" alt="" class="result">
        <div class="content-list">
          <div v-for="item in scratchData.scratch_info.list">
            <img :class="[{'bonus': ((scratchData.scratch_info.a == item.data) && isShow)}]" :src="'../../../static/images/scratch_nativeland/'+item.data+'.png'" alt="">
            <img :src="'../../../static/images/scratch_nativeland/prize_'+item.money+'.png'" alt="">
          </div>
        </div>
      </div>
    </div>
    <canvas id="mht" :class="[{'on': payout}]">您的浏览器不支持canvas技术，请更换浏览器</canvas>
  ...
  export default {
    ...
    data() {
      return{
        ...
        img: {
          canvasImg: "http://scard-images.mohasomnang.com/tickets/2019/MHT/MHT-pre.jpg"
        },
    ...
    mounted() {
      this.$nextTick(() => {
        this.canvas = document.getElementById('mht');
        // this.initAudio();
...
<style lang="less" scoped>
  .mht{
    ...
    .data-show{
      ...
      padding-left: 15px;
      padding-right: 15px;
      background: url(http://scard-images.mohasomnang.com/tickets/2019/MHT/MHT-open.jpg);
    ...
    .serial-number {
      ...
      top: 50%;
      z-index: 2;
      transform: translate3d(-202.5px, 205px, 0);
      padding: 2px 7.5px;
  ...
  .content{
    ...
    .result{
      ...
      top: 50%;
      left: 50%;
      transform: translate3d(165px, -67.5px, 0);
    }
    .bonus{
    ...
    .content-list{
      ...
      width: 340.5px;
      height: 225px;
      transform: translate3d(-228px, -60px, 0);
      div{
        position: absolute;
        top: 50%;
        left: 50%;
        ...
        &:nth-of-type(1) {
          transform: translate3d(-160px, -108px, 0);
        }
        &:nth-of-type(2) {
        ...
        &:nth-of-type(4) {
          transform: translate3d(-160px, -3px, 0);
        }
        &:nth-of-type(5) {
