<template lang="html">
  <div class="ysm">
    <div ref="produce" class="data-show" v-show="isShowPage">
      <div class="content">
        <div class="content-list" v-for="item in scratchData.scratch_info.list" :class="[{'bonus': (( (item.data == scratchData.scratch_info.a[0]) || (item.data == scratchData.scratch_info.a[1]) ) && isShow)}]">
          <p>{{item.data}}</p>
          <img :src="'../../../static/images/scratch_yeaysom/'+item.money+'.png'" alt="">
        </div>
      </div>
      <div class="result">
        <span v-for="item in scratchData.scratch_info.a">{{item}}</span>
      </div>
    </div>
    <canvas id="ysm" :class="[{'on': payout}]">您的浏览器不支持canvas技术，请更换浏览器</canvas>
  ...
  export default {
    ...
    data() {
      return{
        ...
        img: {
          canvasImg: "http://scard-images.mohasomnang.com/tickets/2019/YSM/YSM-pre.jpg"
        },
    ...
    mounted() {
      this.$nextTick(() => {
        this.canvas = document.getElementById('ysm');
...
<style lang="less" scoped>
  .ysm{
    ...
    .data-show{
      ...
      padding-left: 15px;
      padding-right: 15px;
      background: url(http://scard-images.mohasomnang.com/tickets/2019/YSM/YSM-open.jpg);
      ...
      .content{
        ...
        .content-list{
          ...
          font-weight: 700;
          &:nth-of-type(1){
            transform: translate3d(-185px, -105px, 0);
          }
          &:nth-of-type(2){
            transform: translate3d(-86px, -105px, 0);
          }
          &:nth-of-type(3){
            transform: translate3d(0, -105px, 0);
          }
          &:nth-of-type(4){
            transform: translate3d(92px, -105px, 0);
          }
          &:nth-of-type(5){
            transform: translate3d(-185px, -22.5px, 0);
          }
          &:nth-of-type(6){
            transform: translate3d(-86px, -22.5px, 0);
          }
          &:nth-of-type(7){
            transform: translate3d(0, -22.5px, 0);
          }
          &:nth-of-type(8){
            transform: translate3d(92px, -22.5px, 0);
          }
        }
        img{
          height: 20px;
      ...
      .result{
        ...
        span{
          ...
          &:nth-of-type(2) {
            transform: translate3d(283px, -130px, 0);
          }
    ...
    .serial-number {
      ...
      top: 50%;
      z-index: 2;
      transform: translate3d(-198px, 203px, 0);
      padding: 2px 7.5px;
